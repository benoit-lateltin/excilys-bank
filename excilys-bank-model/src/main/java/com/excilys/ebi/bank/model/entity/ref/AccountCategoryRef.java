...
public class AccountCategoryRef extends Ref {
	...
	public void setId(AccountCategory id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AccountCategoryRef other = (AccountCategoryRef) obj;
		if (id != other.id)
			return false;
		return true;
	}
